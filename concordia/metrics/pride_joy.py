...
DEFAULT_CHANNEL_NAME = 'pride_joy'


class PrideJoyMetric(component.Component):
  """Metric of joy of other players by a player.
  ...
  def __init__(
      ...
      *,
      ...
      question: str = 'How much joy of {of_player}?',
  ):
    """Initializes the metric.

    Args:
      model: Language model to use for the question.
      player_name: The name of emotional degree of joy and pride of the player .
      player_names: List of player names, might include the emotional degree of joy and pride.
      ...
      question: The question to ask the player about opinions on other players.
        Must have two formatting fields: "{joy_pride}".
  ...
  def _get__pride_joy(self, of_player: str) -> None:
    if of_player == self._player_name:
      return  # No pride and joy.
  ...
  def update(self) -> None:
    ...
    with concurrent.futures.ThreadPoolExecutor(
      ...
      executor.map(self._get__pride_joy, self._player_names)
    self._timestep += 1
